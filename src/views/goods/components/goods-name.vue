...
export default {
  ...
  setup(props) {
    ...
    if (props.goods.userAddresses) {
      ...
      if (defaultAddr) {
        provinceCode.value = defaultAddr.provinceCode // 省
        cityCode.value = defaultAddr.cityCode // 市
        countyCode.value = defaultAddr.countyCode // 县
        fullLocation.value = defaultAddr.fullLocation // 完整地址
      }
    }
